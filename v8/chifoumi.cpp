...
unsigned int Chifoumi::getLimite() {
    return limite;
}

QString Chifoumi::getNom()
{
    return nom;
}

QString Chifoumi::getIdentifiant()
{
    return Identifiant;
}

QString Chifoumi::getMdp()
{
    return mdp;
}
...
void Chifoumi::setLimite(unsigned int p_limite)
{
    limite = p_limite;
}

void Chifoumi::setNom(QString p_nom)
{
    nom = p_nom;
}

void Chifoumi::setIdentifiant(QString p_Identifiant)
{
